...
> 대체됐다. 현재 업로드 대상은 `launch-plan/README.md` §0에 있다.
>
> **여기 없는 것 둘**:
...
> **`260831-_ACTIVE_BACKLOG.md`** 에 있다(2026-08-31에 세대가 한 번 더 넘어갔다 — 중간 세대인
...
40. 스토어 스크린샷 재캡처 + 비공개 테스트 AAB 빌드 (AI 모델: Opus, 노력정도: 중간) [완료]
    ...
    - **AAB 빌드 완료**: `make play-internal-aab TARGET=emu` → `dist/go-ai-coach-play-internal.aab`
      ...
      현재 업로드 대상과 해시는 `launch-plan/README.md` §0을 볼 것.
...
18. 봇 캐릭터 개별 구매 배선 — **이관됨(2026-08-30).** 현재 위치는 `260831-_ACTIVE_BACKLOG.md` [이관]
...
여기에 덧붙이지 말 것 — 새 일감은 **`260831-_ACTIVE_BACKLOG.md`** 가 받는다
