...
> **`260906-_ACTIVE_BACKLOG.md`** 에 있다(2026-08-31에 세대가 한 번 더 넘어갔다 — 중간 세대인
...
18. 봇 캐릭터 개별 구매 배선 — **이관됨(2026-08-30).** 현재 위치는 `260906-_ACTIVE_BACKLOG.md` [이관]
...
여기에 덧붙이지 말 것 — 새 일감은 **`260906-_ACTIVE_BACKLOG.md`** 가 받는다
