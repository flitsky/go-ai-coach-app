...
```text
event=ai_turn_begin phase=ai_turn app="바둑 AI" purpose="..." mode=AiVsHuman setup="..." board="..." engine=KataGo engineReady=true engineBusy=true runtime="..." analysis="topMoves=true cache=... coverage=..." score="..." turnTime="Time B 12.3s / W 8.1s" flags="..." transition=await_human_move detail="..."
```
