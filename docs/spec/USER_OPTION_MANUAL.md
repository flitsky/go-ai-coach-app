...
>
> - **기능 게이팅 미반영**: `Undo`/`Top Moves`/`Eval`은 더 이상 상시 무료가 아니다 — 프리미엄·클레임·소모품 1회권으로 게이팅되며 잠긴 상태에서 누르면 업셀 또는 1회권 사용 확인 팝업이 뜬다. 정책 원본은 `launch-plan/README.md` 2장, `feature-access-principles/README.md`.
