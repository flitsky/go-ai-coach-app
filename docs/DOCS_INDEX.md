...
| `docs/roadmap/260830-_POST_LAUNCH_ENHANCEMENTS.md` | 위 백로그에서 갈라 나온 **출시 이후 고도화 항목**(2026-08-30 신설). #39 돋보기 드래그 착수 · #26 프리미엄 월 구독 전환 · #18 봇 캐릭터 개별 구매(콘솔 게이트로 이관) · #32·#33 한국어 하드코딩 i18n. 표기 규칙과 착수 프로토콜은 원 백로그와 동일하다 |
