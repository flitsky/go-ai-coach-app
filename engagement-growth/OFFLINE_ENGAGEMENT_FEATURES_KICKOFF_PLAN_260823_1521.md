...
- ⚠️ **미확정**: '광고 스킵권'이 스킵하는 대상(어느 광고 노출 지점인지)과 1회의 범위(대국 1판인지
  광고 1회인지). 구현 착수 전 확인 필요.
...
- ⚠️ **미확정**: Claim 하지 않고 넘어간 과거 일차 보상의 처리(무기한 보관 vs 만료). 밀린 보상이
  여러 일차 쌓였을 때 한 팝업에 모아 보여줄지도 함께 정해야 한다.
