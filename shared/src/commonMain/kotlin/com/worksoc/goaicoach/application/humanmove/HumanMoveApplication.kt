...
sealed class HumanEngineSyncRuntimeLogPlan {
...
sealed class HumanEngineSyncCompletionApplyPlan {
...
sealed class HumanEngineSyncWorkflowResult {
...
fun buildHumanEngineSyncSuccessPlan(
    afterMove: GameState,
...
fun buildHumanEngineSyncFailurePlan(
    localMove: HumanMoveLocalResult,
    previousSnapshots: List<ScoreSnapshot>,
    errorMessage: String?,
...
fun buildHumanEngineSyncSuccessCompletionPlan(
...
fun buildHumanEngineSyncFailureCompletionPlan(
    operation: EngineOperationRequest,
    currentState: GameState,
    currentSessionGeneration: Long,
    localMove: HumanMoveLocalResult,
...
fun HumanEngineSyncCompletionPlan.toRuntimeLogPlan(): HumanEngineSyncRuntimeLogPlan =
    when (this) {
...
fun HumanEngineSyncCompletionPlan.toApplyPlan(): HumanEngineSyncCompletionApplyPlan =
    when (this) {
        is HumanEngineSyncCompletionPlan.ApplySuccess ->
...
fun runHumanEngineSyncApplication(request: HumanEngineSyncRunRequest) {
    val operation = engineOperationRequest(
        kind = EngineOperationKind.HumanMoveSync,
