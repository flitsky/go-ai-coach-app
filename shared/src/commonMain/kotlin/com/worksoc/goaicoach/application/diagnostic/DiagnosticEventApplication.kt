...
fun engineVisitFillDiagnosticEvent(
    requestedVisits: Int,
    rootVisits: Int?,
    searchMode: String,
...
fun engineOperationSlowDiagnosticEvent(
    operation: String,
    elapsedMillis: Long,
...
fun engineOperationTimeoutDiagnosticEvent(
    operation: String,
    timeoutMillis: Long,
    positionFingerprint: String? = null,
): DiagnosticEvent {
...
fun engineOperationDiscardedDiagnosticEvent(
