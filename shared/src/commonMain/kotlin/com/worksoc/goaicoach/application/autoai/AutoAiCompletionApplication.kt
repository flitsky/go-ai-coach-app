...
fun evaluateAutoAiTurnResultGuard(
...
sealed class AutoAiTurnCompletionPlan {
...
sealed class AutoAiTurnWorkflowResult {
    data class Success(
        val display: AutoAiTurnDisplayPlan,
...
fun buildAutoAiTurnSuccessCompletionPlan(
    token: AutoAiTurnOperationToken,
    currentState: GameState,
...
fun buildAutoAiTurnFailureCompletionPlan(
    token: AutoAiTurnOperationToken,
    currentState: GameState,
    currentSessionGeneration: Long,
    error: Throwable,
...
fun evaluateAutoAiEndgameResultGuard(
