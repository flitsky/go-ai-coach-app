...
sealed class ScoreSyncCompletionApplyPlan {
    data class ApplySuccess(
        val display: ScoreEstimateDisplayPlan,
        val followUpAnalysisState: GameState,
...
data class ScoreSyncCompletionRequest(
...
fun ScoreSyncCompletionPlan.toApplyPlan(): ScoreSyncCompletionApplyPlan =
    when (this) {
...
fun buildScoreSyncSuccessCompletionPlan(
...
fun buildScoreSyncFailureCompletionPlan(
    request: ScoreSyncCompletionRequest,
    error: Throwable,
...
suspend fun runScoreSyncWorkflowCompletionPlan(
    operation: EngineOperationRequest,
    currentState: GameState,
    currentSessionGeneration: Long,
    followUpAnalysisState: GameState,
