...
/**
 * `HttpRemotePositionAnalysisTransport`(실제 JVM/HTTP 구현체) 자체에 대한 테스트는
 * `engine-android` 모듈로 옮겨졌다(260804 정리) — 이 파일은 [RemotePositionAnalysisGateway]가
 * `:shared`의 [RemotePositionAnalysisTransport] 계약을 올바르게 호출/포장하는지만 검증한다.
 */
