...
internal val UiStringsJapanese = UiStringsKorean.copy(
    ...
    languageLabel = "言語",
    settingsFontScaleTitle = "文字サイズ",
    settingsFontScaleNormal = "標準",
    settingsFontScaleLarge = "大きく",
    close = "閉じる",
    gameSection = "ゲーム",
    newGame = "新規",
    copyLog = "ログコピー",
    ...
    confirm = "確認",
    rerunBenchmark = "再測定",
    benchmarkBlockedTitle = "今は測定できません",
    benchmarkBlockedEngineNotReady = "AIエンジンがまだ準備中です。少し経ってからもう一度押してください。",
    benchmarkBlockedUnsupported = "この端末では性能測定に対応していません。",
    benchmarkBlockedEngineBusy = "AIが考えています。今の応答が終わってからもう一度押してください。",
    ...
    premiumUpsellPurchaseOption = "プレミアムに登録する",
    ...
    settingsDevTierBasicTitle = "開発者 · 基本",
    settingsDeveloperModeOptInTitle = "開発者モードをオンにしますか？",
    settingsDeveloperModeOptInMessage = "開発者モードに入ると既存のデータはすべて失われます。オンの間は3時間ごとにアプリが初回インストール状態に戻ります。開発者でない場合はオンにしないでください。",
    settingsDeveloperModeOptInConfirm = "オンにする",
    settingsDeveloperModeOffAction = "オフ",
    settingsDeveloperModeOffTitle = "開発者モードをオフにしますか？",
    settingsDeveloperModeOffMessage = "開発者モードをオフにすると、アプリが初回インストール状態に戻ります。出席・キャラクター・1回券・対局記録・設定はすべて消えます。",
    settingsDeveloperModeOffDoneMessage = "開発者モードをオフにしました。初回インストール状態に戻ります",
    settingsDevTierAdvancedTitle = "開発者 · 高度 · debug",
    settingsDevBuildInfoTitle = "ビルド情報",
    settingsDevGrantTicketTitle = "チケット1枚",
    settingsDevGrantTicketSubtitle = "形勢判断 · おすすめ手",
    ...
    settingsDevBenchmarkSubtitle = "1~3分かかります・エンジンが処理中は動きません",
    settingsDevBenchmarkAction = "測定",
    ...
    localOnlyDataNoticeBody = "出席記録・集めたキャラクター・1回券など、アプリにたまるものはこの端末にだけ残ります。アプリを削除したり端末を変えたりすると元に戻せません。",
    ...
    settingsDevSplashTitle = "起動画面の候補",
    settingsDevSplashSubtitle = "番号を押すと全画面で再生します",
    ...
    settingsAdPrivacyOptionsLabel = "広告プライバシー設定",
    settingsDevConsentResetTitle = "同意フォームをリセット",
    settingsDevConsentResetSubtitle = { forced -> if (forced) "EEA 強制 ON — 広告視聴時にフォームが表示される" else "EEA 強制 OFF — local.properties に consent.forceEeaDebug=true" },
    settingsDevConsentResetAction = "リセット",
    settingsPrivacyPolicyLabel = "プライバシーポリシー",
    settingsDeveloperModeEnabledMessage = "開発者モードが有効になりました。",
    premiumModeTitle = "プレミアムモードを有効化",
    premiumModeFeatureList = "形勢判断・候補手・着手評価・待った",
