...
internal val UiStringsKorean = UiStrings(
    ...
    onboardingTitle = "바둑 AI에 오신 것을 환영합니다",
    ...
    localOnlyDataNoticeTitle = "앱을 지우면 사라져요",
    localOnlyDataNoticeBody = "출석 기록·모은 캐릭터·1회권·대국 기록은 이 기기에만 저장돼요. 앱을 지우거나 기기를 바꾸면 되돌릴 수 없어요.",
