...
internal val UiStringsKorean = UiStrings(
    ...
    undoClaimTitle = "무료 프로모션",
    undoClaimMessage = "무르기 기능 프로모션 기간입니다. 영구 활성화 하시겠습니까?",
    undoClaimConfirmAction = "영구 활성화",
    undoClaimSuccessMessage = "구매 완료! 기능 획득! 축하합니다.",
    topMovesAction = "추천 수 받기",
    everyMoveEval = "매 수마다 형세",
    everyMoveTopMoves = "매 수마다 추천 수",
    everyMoveHint = "매 수마다 보려면 대국 메뉴에서 옵션을 켜세요.",
    consumableSpendTitle = "1회권 사용",
    consumableSpendConfirmAction = "사용",
    consumableSpendCancelAction = "취소",
