...
internal val UiStringsKorean = UiStrings(
    ...
    boardModeFull = "최대",
    boardModeInset = "여백",
    playModeDirect = "바로 착수",
    playModeConfirm = "착수 확인",
    coordinates = "좌표",
    playHaptic = "착수 진동",
    moveNumbers = "수순 번호",
    lastMoveRing = "착수 표시",
    ...
    settingsDevTierBasicTitle = "개발자 테스트 (기본)",
    ...
    settingsDeveloperModeOffAction = "개발자 모드 끄기",
    ...
    settingsDevReleaseResetTitle = "정식 출시 초기화 다시 실행",
    ...
    settingsDevPremiumToggleTitle = "프리미엄 모드 영구 활성화 테스트",
