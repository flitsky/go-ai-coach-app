...
internal val UiStringsEnglish = UiStringsKorean.copy(
    ...
    everyMoveTopMoves = "Top moves every move",
    everyMoveHint = "To keep it on every move, enable the option in the game menu.",
    consumableSpendTitle = "Use a ticket",
    consumableSpendConfirmAction = "Use",
    consumableSpendCancelAction = "Cancel",
