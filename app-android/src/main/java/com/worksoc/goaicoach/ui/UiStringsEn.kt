...
internal val UiStringsEnglish = UiStringsKorean.copy(
    ...
    settingsDevTierBasicTitle = "Developer tests (basic)",
    ...
    settingsDeveloperModeOffAction = "Turn off developer mode",
    ...
    settingsDevAttendanceTitle = "Advance check-in by a day",
    settingsDevAttendanceAdvanceAction = "Advance",
    settingsDevReleaseResetTitle = "Re-run the launch reset",
    ...
    settingsDevDiagnosticLogTitle = "Diagnostic event log",
