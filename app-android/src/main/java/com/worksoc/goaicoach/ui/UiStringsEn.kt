...
internal val UiStringsEnglish = UiStringsKorean.copy(
    ...
    benchmarkBlockedTitle = "Can't measure right now",
    benchmarkBlockedEngineNotReady = "The AI engine is still starting up. Try again in a moment.",
    benchmarkBlockedUnsupported = "This device doesn't support the performance check.",
    benchmarkBlockedEngineBusy = "The AI is thinking. Try again once it answers.",
    ...
    premiumUpsellPurchaseOption = "Subscribe to Premium",
    ...
    settingsDevBenchmarkSubtitle = "Takes 1-3 minutes · does nothing while the engine is busy",
    settingsDevBenchmarkAction = "Measure",
    ...
    localOnlyDataNoticeBody = "Check-ins, characters, single-use tickets — what the app builds up stays on this device. Delete the app or switch devices and it is gone.",
    ...
    settingsDevSplashTitle = "Splash candidates",
    settingsDevSplashSubtitle = "Tap a number to play it full screen",
    ...
    premiumModeFeatureList = "Eval · Top Moves · Move Review · Undo",
