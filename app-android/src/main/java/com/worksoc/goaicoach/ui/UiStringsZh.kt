...
internal val UiStringsChineseSimplified = UiStringsKorean.copy(
    ...
    undoClaimTitle = "免费促销",
    undoClaimMessage = "「悔棋」功能正在限时免费促销。要永久解锁吗？",
    undoClaimConfirmAction = "永久解锁",
    undoClaimSuccessMessage = "解锁成功！您已永久获得「悔棋」功能，恭喜！",
    topMovesAction = "查看推荐手",
    everyMoveEval = "每手形势判断",
    everyMoveTopMoves = "每手推荐手",
    everyMoveHint = "若要每手都显示，请在对局菜单中打开该选项。",
    consumableSpendTitle = "使用次券",
    consumableSpendConfirmAction = "使用",
    consumableSpendCancelAction = "取消",
