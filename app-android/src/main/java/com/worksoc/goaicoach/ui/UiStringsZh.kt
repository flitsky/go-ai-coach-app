...
internal val UiStringsChineseSimplified = UiStringsKorean.copy(
    ...
    languageLabel = "语言",
    settingsFontScaleTitle = "字体大小",
    settingsFontScaleNormal = "默认",
    settingsFontScaleLarge = "放大",
    close = "关闭",
    gameSection = "游戏",
    newGame = "新局",
    copyLog = "复制日志",
    ...
    confirm = "确定",
    rerunBenchmark = "重新测量",
    benchmarkBlockedTitle = "现在无法测量",
    benchmarkBlockedEngineNotReady = "AI 引擎仍在启动中，请稍后再试。",
    benchmarkBlockedUnsupported = "此设备不支持性能检测。",
    benchmarkBlockedEngineBusy = "AI 正在思考，等这一手结束后再试。",
    ...
    premiumUpsellPurchaseOption = "订阅高级模式",
    ...
    settingsDevTierBasicTitle = "开发者 · 基础",
    settingsDeveloperModeOptInTitle = "要开启开发者模式吗？",
    settingsDeveloperModeOptInMessage = "进入开发者模式后，现有数据将全部丢失。开启期间，应用每 3 小时会恢复为初次安装状态。如果您不是开发者，请勿开启。",
    settingsDeveloperModeOptInConfirm = "开启",
    settingsDeveloperModeOffAction = "关闭",
    settingsDeveloperModeOffTitle = "要关闭开发者模式吗？",
    settingsDeveloperModeOffMessage = "关闭开发者模式后，应用将恢复为初次安装状态。签到、角色、单次券、对局记录和设置都会消失。",
    settingsDeveloperModeOffDoneMessage = "已关闭开发者模式，将恢复初次安装状态",
    settingsDevTierAdvancedTitle = "开发者 · 高级 · debug",
    settingsDevBuildInfoTitle = "构建信息",
    settingsDevGrantTicketTitle = "领取单次券",
    settingsDevGrantTicketSubtitle = "形势判断 · 推荐着法",
    ...
    settingsDevBenchmarkSubtitle = "需要 1~3 分钟 · 引擎繁忙时不会运行",
    settingsDevBenchmarkAction = "测量",
    ...
    settingsDevSplashTitle = "启动画面候选",
    settingsDevSplashSubtitle = "点按编号即可全屏播放",
    ...
    settingsAdPrivacyOptionsLabel = "广告隐私设置",
    settingsDevConsentResetTitle = "重置同意表单",
    settingsDevConsentResetSubtitle = { forced -> if (forced) "EEA 强制 ON — 观看广告时显示表单" else "EEA 强制 OFF — 在 local.properties 设置 consent.forceEeaDebug=true" },
    settingsDevConsentResetAction = "重置",
    settingsPrivacyPolicyLabel = "隐私政策",
    settingsDeveloperModeEnabledMessage = "开发者模式已启用。",
    premiumModeTitle = "激活高级模式",
    premiumModeFeatureList = "形势判断・推荐手・着法评价・悔棋",
