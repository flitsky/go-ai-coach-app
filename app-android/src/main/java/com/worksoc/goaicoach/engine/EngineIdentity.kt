...
data class EngineIdentity(
    ...
    companion object {
         ...
         * 빈 값이면 좌석이 **이름 없이** 그려진다. `"AI"`는 4개 언어에서 모두 읽힌다.
         * ⚠️ 한때 *"앱 이름(바둑 AI 코치)과도 맞는다"* 를 근거로 들었는데, 2026-09-11 이름이 `포켓 바둑 코치`가
         * 되며 **이름에서 'AI'가 빠졌다**(#137) — 그 근거는 더 이상 없다. 남는 근거는 4개 언어 가독성뿐이다.
         *
