...
ENGINE_MATCH_OUT ?= docs/measurements/engine-match/matrix-20260610
ENGINE_MATCH_ARGS ?=
ENGINE_DEVICE_BENCHMARK_SAMPLES ?= 10
ENGINE_DEVICE_BENCHMARK_OUT ?= docs/measurements/engine-benchmark/mac-20260610
ENGINE_DEVICE_BENCHMARK_ARGS ?=
ENGINE_SEARCH_MODE_BENCHMARK_SAMPLES ?= 5
ENGINE_SEARCH_MODE_BENCHMARK_OUT ?= docs/measurements/engine-benchmark/search-mode-mac-20260613
ENGINE_SEARCH_MODE_BENCHMARK_ARGS ?=
ENGINE_PHONE_BENCHMARK_SERIAL ?= $(ANDROID_SERIAL)
ENGINE_PHONE_SEARCH_MODE_BENCHMARK_OUT ?= docs/measurements/engine-benchmark/search-mode-phone-latest
